    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (id == null) {
            ...
            if (fromDate.isEmpty() && toDate.isEmpty()) {
                filteredMeal = mealRestController.getFilteredByTime(fromTime, toTime);
            } else {
                filteredMeal = mealRestController.getFilteredByDateTime(fromDate, fromTime, toDate, toTime);
            }
